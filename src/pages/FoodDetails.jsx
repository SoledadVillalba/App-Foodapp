...
import products from "../asset/data-falsa/productos";
        ...
        <Row>
          ...
          <Col lg="6" md="6">
            <div className="single__product-content">
              ...
              <button onClick={addItem} className="addTOCart__btn">Pedir</button>
            </div>
          </Col>
          ...
          <Col lg="12">
             <div className="tabs d-flex align-items-center gap-5 py-3">
               ...
               onClick={()=> setTab('desc')}>Descripción</h6>
               <h6 className={`${tab === 'rev' ? 'tab__active':'' }`}
               onClick={()=> setTab('rev')}>Valoración</h6>
              </div>
             ...
             <div className="review pt-5">
              ...
              <p className="feedback__text">Excelnte Producto</p>
             </div> 
                   ...
                   <form className="form"onSubmit={submitHandler}>
                      ...
                      <div className="form__group">
                        <input type="text" placeholder="Dirección de Mail"
                      ...
                      <button className="addTOCart__btn">Enviar</button>
                  </form>
             </div> 
              }
          ...
          <Col lg="12" className="mb-5 mt-4">
            <h2 className="related__Product-title">Productos populares</h2>
          </Col>
